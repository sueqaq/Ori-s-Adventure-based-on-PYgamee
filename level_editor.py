...
blob_img = pygame.image.load('img/blob1.png')
platform_x_img = pygame.image.load('img/platform_grass_x.png')
platform_y_img = pygame.image.load('img/platform_grass_y.png')
